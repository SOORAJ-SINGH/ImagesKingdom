...
Public Class cDataAccess
    ...
    Public Function OpenConnection() As SqlConnection
        ...
        Try
            If mCN = String.Empty Then
                'ret_conn = New SqlConnection(Convert.ToString(ConfigurationManager.ConnectionStrings["ConString"].ConnectionStrings))'
    ...
    '            SqlDataAdapter da = new SqlDataAdapter(strSP,con);
