<%@ Page Title="LightBox" Language="C#" AutoEventWireup="true" CodeFile="LightBoxMessage.aspx.cs"
    Inherits="LightBoxMessage" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="page-heading" align="center" background="images/curve-top-center.jpg">
                                        <asp:Label ID="lblHead" runat="server" Text="My Lightbox" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                    </td>
                                    <td width="6">
